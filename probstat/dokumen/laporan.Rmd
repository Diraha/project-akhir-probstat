...
Berdasarkan hasil analisis, rata-rata persentase yang dihasilkan sebesar 0.45%, yang artinya metode panghapusan dapat dilakukan untuk menangani masalah ini, karena proporsi missing value < 1% dari total observasi, data yang mengandung missing value dihapus dengan asumsi kehilangan data tidak memberikan dampak signifikan.
