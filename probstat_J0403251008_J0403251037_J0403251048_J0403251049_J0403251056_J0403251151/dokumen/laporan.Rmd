...
\begin{center}
\textbf{Gambar 3.1 Hasil Analisis MCAR}
\end{center}
...
Selain analisis numerik, dilakukan juga visualisasi data menggunakan histogram dan boxplot. Histogram digunakan untuk mangamati bentuk distribusi, tingkat kemiringan (\textit{skewbess}), dan pola penyebaran data, sedangkan boxplot digunakan untuk mendeteksi keberadaan nilai pencilan (\textit{outlier}) serta melihat posisi median dan rentang kuartil data.

\begin{center}
\textbf{Gambar 3.2 Boxplot \textit{Outlier}}
\end{center}

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics("../gambar/boxplot_outlier.png")
```

\begin{center}
\textbf{Gambar 3.3 Histogram Log PDRB Perkapita}
\end{center}

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics("../gambar/histogramLogPDRBPerkapita.png")
```

\begin{center}
\textbf{Gambar 3.4 Histogram Log Kemiskinan}
\end{center}

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics("../gambar/histogramLogKemiskinan.png")
```

\begin{center}
\textbf{Gambar 3.5 Histogram Log Pengangguran}
\end{center}

```{r echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics("../gambar/histogramLogPengangguran.png")
```
...
```{r hist_ipm, echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics("../gambar/histogramIPM.png")
```
...
```{r hist_kemiskinan, echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics("../gambar/histogramKemiskinan.png")
```
...
```{r boxplot_pdrb, echo=FALSE, fig.align='center', out.width='75%'}
knitr::include_graphics("../gambar/bloxpotPDRBperKapita.png")
```
...
```{r scatter_kemiskinan_ipm, echo=FALSE, fig.align='center', out.width='75%'}
...
```{r scatter_internet_sekolah, echo=FALSE, fig.align='center', out.width='75%'}
...
\begin{center}
\textbf{Tabel 3.7 Hasil Analisis Korelasi}
...
\begin{center}
\textbf{Gambar 3.6 Diagram Batang Horizontal Koefisien Korelasi Antar Variabel Pembangunan Wilayah}

\includegraphics[width=15cm]{../gambar/visualisasi_nilai_korelasi.png}
\end{center}

Hal ini menunjukkan bahwa hubungan linear antar variabel dalam dataset pembangunan wilayah sangat lemah.
